use crate::{board::Board, color_schemes::THEMES, game::Game, input::Tool, utils::GColor};
use egui_macroquad::{
    egui::{self, ComboBox, RichText, Ui},
    ui,
};
            ...
            egui::Window::new("Settings").show(ctx, |ui| {
                ...
                if self.config.enable_heat {
                    ...
                    if self.config.soft_heat {
                        ...
                        ui.add(
                            egui::Slider::new(&mut heat_f32, 0.0..=255.).text("Soft heat amount"),
                        );
